...
$(() => {
  ...
  $('#changePWlink').on('click', () => { $('.sign-in-hide').hide(); $('.sign-up-hide').hide(); $('.house-block-parent').hide(); $('.change-pwd-hide').show(); $('#messages').hide(); $('.edit-hide').hide(); $('.create-hide').hide() })
  $('.createlisting').on('click', () => { $('.house-block-parent').hide(); $('.change-pwd-hide').hide(); $('#messages').hide(); $('.create-hide').show(); $('.edit-hide').hide() })
